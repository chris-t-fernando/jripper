...
//	http.open('get', location.protocol+'//'+location.hostname);
	http.open('get', 'http://j-diamonds-ro-lt.s3.amazonaws.com');
...
for(i=0; i<filex.length; i++){
	//if ( filex[i].getElementsByTagName('Key')[0].firstChild.data.indexOf('chris/rips/') == 0 )
	//{
        	fileData =new Array();
	        fileList[count] = fileData;
		count++;
		size = filex[i].getElementsByTagName('Size')[0].firstChild.data;
		name = filex[i].getElementsByTagName('Key')[0].firstChild.data.replace('chris/rips/','');
		lastmod = filex[i].getElementsByTagName('LastModified')[0].firstChild.data;
//        	link = "<A HREF=\""+name+"\">"+name+"</A>";
// <a href="#" onclick="document.getElementById('track').src='https://fdoarchive.s3.amazonaws.com/chris/rips/1%20Dads%20-%20Live%20at%20the%20Wireless%202015-08-31.mp3';document.getElementById('track').load();document.getElementById('track').play();return false;">play</a>

		link = "<A HREF=\"#\" onclick=\"document.getElementById('track').src='https://j-diamonds-ro-lt.s3.amazonaws.com/"+name+"';document.getElementById('track').load();document.getElementById('track').play();return false;\">"+name+"</a>";
...
<audio id="track" src="https://j-diamonds-ro-lt.s3.amazonaws.com/1%20Dads%20-%20Live%20at%20the%20Wireless%202015-08-31.mp3">
</audio>

<a href="#" onclick="document.getElementById('track').src='https://j-diamonds-ro-lt.s3.amazonaws.com/1%20Dads%20-%20Live%20at%20the%20Wireless%202015-08-31.mp3';document.getElementById('track').load();document.getElementById('track').play();return false;">play</a>
